...
/**
 * \internal
 * \brief The function extracts a single precision floating point value from
 *        a payload buffer.
 *
 * The function reads four bytes from the given payload buffer starting at the
 * requested position and interprets them as a single precision floating point
 * value, which will be returned. If needed the byte order is swapped to convert
 * from the payload's little endian format to the CPU's endian format.
 *
 * \param[in] payload  A pointer to a block of payload data.
 * \param[in] offset   The byte position at which the requested data value
 *                     starts.
 ...
 * \return The function returns the value read from the payload.
 */
static inline float protocol_read_payload_float32(const uint8_t* payload,
                                                  uint16_t offset)
{
    union
    {
    ...
    conversion_helper.u32 = protocol_read_payload_uint32(payload, offset);
    return conversion_helper.f32;
}

/*
 * @TODO: description
 */
static inline int16_t protocol_read_payload_string(const uint8_t* payload,
                                                   uint16_t offset,
                                                   char** dest)
{
    uint16_t str_len = payload[offset];

    *dest = (char*)malloc(str_len + 1);

    memcpy(*dest, payload + offset + 1, str_len);
    (*dest)[str_len] = '\0';
 ...
 *
 * \return The function returns the number of bytes that have been added to
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_int8(uint8_t* payload,
                                                   uint16_t offset,
                                                   int8_t value)
{
    payload[offset] = (uint8_t)value;
    return (uint16_t)sizeof(int8_t);
}
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_uint8(uint8_t* payload,
                                                    uint16_t offset,
                                                    uint8_t value)
{
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_int16(uint8_t* payload,
                                                    uint16_t offset,
                                                    int16_t value)
{
    payload[offset + 1] = (((uint16_t)value) >>  8) & 0xFF;
    payload[offset    ] =  ((uint16_t)value)        & 0xFF;
    return (uint16_t)sizeof(int16_t);
}
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_uint16(uint8_t* payload,
                                                     uint16_t offset,
                                                     uint16_t value)
{
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_int32(uint8_t* payload,
                                                    uint16_t offset,
                                                    int32_t value)
{
    ...
    return (uint16_t)sizeof(int32_t);
}
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_uint32(uint8_t* payload,
                                                     uint16_t offset,
                                                     uint32_t value)
{
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_int64(uint8_t* payload,
                                                    uint16_t offset,
                                                    int64_t value)
{
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_uint64(uint8_t* payload,
                                                     uint16_t offset,
                                                     uint64_t value)
{
...
/**
 * \internal
 * \brief The function writes a single precision floating point value to a
 *        payload buffer.
 *
 * The function writes the given value into the given payload buffer at the
 * requested position. If needed the byte order is swapped to convert from the
 ...
 *         to the payload block.
 */
static inline uint16_t protocol_write_payload_float32(uint8_t* payload,
                                                      uint16_t offset,
                                                      float value)
{
    union
    ...
    conversion_helper.f32 = value;
    return protocol_write_payload_uint32(payload, offset,
                                         conversion_helper.u32);
}
