...
const char* ep_radar_get_error_code_description(uint16_t error_code)
{
    switch (error_code)
    {
		...
		case EP_RADAR_ERR_PARAMETER_OUT_OF_RANGE:
			return "The specified parameter, or one of the parameters is out of range.";
        ...
        case EP_RADAR_ERR_MEMORY_TEST_FAILED:
            return "The On-Chip FIFO memory test failed.";
        ...
        case EP_RADAR_ERR_BANDGAP_DELAY_OUT_OF_RANGE:
            return "The specified bandgap startup delay is out of range.";
        ...
        case EP_RADAR_ERR_AAF_FREQ_NOT_SUPPORTED:
            return "The specified anti alias filter frequency is not supported.";

        case EP_RADAR_ERR_TX_TOGGLE_MODE_NOT_SUPPORTED:
            return "The specified TX toggle mode is not supported.";

        case EP_RADAR_ERR_TEST_CONFLICT_BB_TX:
            return "Baseband test and TX toggle test can't be used simultaniously.";
        ...
        case EP_RADAR_ERR_MSG_SIZE_CORRUPT:
        	return "Message size is corrupt.";
