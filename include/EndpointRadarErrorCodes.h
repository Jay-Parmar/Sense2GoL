...
/** 
* The specified parameter or one of the parameters is out of range 
*/
#define EP_RADAR_ERR_PARAMETER_OUT_OF_RANGE      0x000C  
 ...
 * by the device.
 */
#define EP_RADAR_ERR_UNSUPPORTED_FREQUENCY        0x0137

/**
 * The specified FIFO power mode is not supported.
 */
#define EP_RADAR_ERR_UNSUPPORTED_FIFO_POWER_MODE  0x0140

/**
 * The specified pad driver mode is not supported.
 */
#define EP_RADAR_ERR_UNSUPPORTED_PAD_DRIVER_MODE  0x0141

/**
 * The specified bandgap startup delay is out of range.
 */
#define EP_RADAR_ERR_BANDGAP_DELAY_OUT_OF_RANGE      0x0142

/**
 * The specified MADC startup delay is out of range.
 */
#define EP_RADAR_ERR_MADC_DELAY_OUT_OF_RANGE         0x0143

/**
 * The specified PLL startup delay is out of range.
 */
#define EP_RADAR_ERR_PLL_ENABLE_DELAY_OUT_OF_RANGE   0x0144

/**
 * The specified PLL Divider startup delay is out of range.
 */
#define EP_RADAR_ERR_PLL_DIVIDER_DELAY_OUT_OF_RANGE  0x0145

/**
 * The specified clock doubler mode is not supported.
 */
#define EP_RADAR_ERR_DOUBLER_MODE_NOT_SUPPORTED        0x0146

/**
 * The specified input duty cycle correction is out of range.
 */
#define EP_RADAR_ERR_DC_IN_CORRECTION_OUT_OF_RANGE     0x0147

/**
 * The specified output duty cycle correction is out of range.
 */
#define EP_RADAR_ERR_DC_OUT_CORRECTION_OUT_OF_RANGE    0x0148

/**
 * The specified anti alias filter frequency is not supported.
 */
#define EP_RADAR_ERR_AAF_FREQ_NOT_SUPPORTED            0x0149

/**
 * The specified TX toggle mode is not supported.
 */
#define EP_RADAR_ERR_TX_TOGGLE_MODE_NOT_SUPPORTED      0x014A

/**
 * Baseband test and TX toggle test can't be used simultaniously.
 */
#define EP_RADAR_ERR_TEST_CONFLICT_BB_TX               0x014B

/**
 * The specified power sensing delay is out of range.
 */
#define EP_RADAR_ERR_POWER_SENS_DELAY_OUT_OF_RANGE     0x014C
 ...
 */
#define EP_RADAR_ERR_NO_SWITCH_TIME_MADC_TEMP          0x014F

/**
 * The chirp end delay is not long enough for temperature measurement.
 */
#define EP_RADAR_ERR_NO_MEASURE_TIME_MADC_TEMP         0x0150

/**
 * When temperature sensing is enabled, chirps with all RX channels disabled
 * are not allowed.
 */
#define EP_RADAR_ERR_TEMP_SENSING_WITH_NO_RX           0x0151

/**
 * The message size does not fit.
 */
#define EP_RADAR_ERR_MSG_SIZE_CORRUPT		           0x0180
