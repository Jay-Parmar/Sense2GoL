...
#define IFX_RADAR_VID "058B"
#define IFX_RADAR_PID "0058"

/* vendor id for form factor board */
#define IFX_RADAR_FF_PID "0250"
 ...
 */
size_t com_get_data(com_t* com_port, void* data, size_t num_requested_bytes);
